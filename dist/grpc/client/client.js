...
exports.updateUserRating = exports.getUserDetails = exports.getUserRating = exports.getAuthToken = void 0;
...
const getUserDetails = (ids) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolve, reject) => {
        userClient.GetUsersDetails({ ids }, (error, response) => {
            if (error)
                reject(error);
            else
                resolve(response);
